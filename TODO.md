...
- [ ] `archives/todo/` の各ファイルにある `docs/2026...` の参照を直す
- [ ] `tests/test_midi_writer.py` の docstring にある参照を直す

要求書 2 通・回答書 2 通を `docs/` から `archives/` へ移したので、
それらを指している他の文書・コードのパスが古いままになっている。
